...
exports.mwAuth = (req, res, next) => { // n1
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVkYjQzMDFlZDM5YTRlMTI1NDYyNzdhOCIsImlhdCI6MTU3NDIxMDUwNCwiZXhwIjoxNTc0ODE1MzA0fQ.HAUlZ6lCHxRuieN5nizug_ZMTEuAmJ2Ck22uCcBkmeY" // req.header('x-auth-token');
    ...
    try {
        ...
        req.authObj = decoded; // eg we got this id to process in checkUserAuth { id: '5db4301ed39a4e12546277a8', iat: 1574210504, exp: 1574815304 }
    } catch (err) {
...
// END MIDDLEWARES
// this will load the authorized user's data after token validation in mwAuth
